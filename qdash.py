...
class FinancialData:
    ...
    def compute_seasonality(self) -> pd.DataFrame:
        ...
        # Edge case: some years have 53 weeks in isocalendar. Replace if needed:
...
class DashboardVisualizer:
    ...
    def create_comparison_charts(self) -> Tuple[Optional[go.Figure], Optional[go.Figure]]:
        """Create gap and ratio charts if secondary data is available."""
        ...
        # Align secondary data with primary data by forward-filling
...
def main():
    ...
    try:
        # Fetch and prepare primary data
        ...
        # Display comparison charts if secondary data is available
        if secondary_data:
